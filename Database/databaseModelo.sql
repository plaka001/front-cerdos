...
--
-- TOC entry 1234 (class 1259 OID 23000)
...
--
-- TOC entry 1234 (class 1259 OID 23001)
...
--
-- TOC entry 1234 (class 2606 OID 23005)
...
--
-- TOC entry 1234 (class 0 OID 23000)
-- Dependencies: 1234
...
--
-- TOC entry 1234 (class 3256 OID 23010)
-- Name: reglas_sanitarias Acceso total reglas; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Acceso total reglas" ON public.reglas_sanitarias TO authenticated USING (true) WITH CHECK (true);

--
-- TOC entry 391 (class 1259 OID 23630)
